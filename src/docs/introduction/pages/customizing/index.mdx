...
If we stopped here, perhaps you couldn't do much customizations with this properties. So, all documents have one more property that you can define if you want to customize your document, that is the `settings` property:
...
With the `settings` property you can really do whatever you want, since your theme lead with this property. Example: you can define if your document is a page with `100%` of width or not.
...
What you see above is our [docz-default-theme](https://github.com/doczjs/docz/tree/master/packages/docz-theme-default). It's very minimalist, but have what you need to write a beautiful documentation.
