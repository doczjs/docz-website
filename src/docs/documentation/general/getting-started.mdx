...
As you proceed in your usage, you will likely need to configure your docz config and themes with a `doczrc.js` file. Please read our [Customizing](/docs/migration-guide) and [Project Configuration](/docs/project-configuration) docs.
