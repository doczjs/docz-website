...
> Since v1 you need `react` and `react-dom` with `>= 16.8.0` installed.

## ✅️ &nbsp; Migration Guide

This documentation it's about our [new v1](https://github.com/pedronauck/docz/pull/656).
If you need to migrate your docz project, please read our [Migration Guide](https://github.com/pedronauck/docz/blob/master/MIGRATION_GUIDE.md)

## Installation

First, you need to install docz on your project using some package manager (we're assuming [Yarn](https://yarnpkg.com/) here):
