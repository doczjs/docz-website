...
Get you the type definition of a specific component defined by the query.
Can be useful when you need data from type definition found by docgen, one use case would be if you want to filter all components relatively to a group of type.
