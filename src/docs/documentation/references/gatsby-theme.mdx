...
```
yarn add gatsby gatsby-theme-docz@next docz@next docz-theme-default@next -D
```
...
set some default options for your theme, you can set `options` on theme definition.
...
## Getting data from Docz

Using our Gatsby Theme you can enjoy all our hooks to get data for your pages.
So, you can create isolated pages on Gatsby using gatsby pages and get data from Docz. Cool right?
