...
You could then use this property when overriding or creating a theme as shown in [**Creating your themes: Using documents settings**](/docs/creating-your-themes#using-documents-settings)
