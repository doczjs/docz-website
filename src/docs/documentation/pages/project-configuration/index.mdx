...
Use this property to specify the theme for your site. You can pass the name of your theme if is a package like `docz-theme-default` and the docz will attempt to load the theme component at `node_modules/docz-default-theme`, or if you want to use some file inside you project, you can just pass the location relative to the `src/` folder. If your theme component is inside the `src/theme/index.js` folder, just pass `/theme` in this option.
