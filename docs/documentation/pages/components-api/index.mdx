...
This is a [render props](https://reactjs.org/docs/render-props.html) component to use inside your theme. You can get the list of all docs parsed. It can be useful when you want to create something like a menu or a list.
